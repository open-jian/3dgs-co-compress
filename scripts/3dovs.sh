...
RGB_ROOT="${OUTPUT_ROOT}/rgb_3dgs/3dovs"
MODEL_ROOT="${OUTPUT_ROOT}/colasplat/semantic/3dovs"
...
for i in "${!casenames[@]}"; do
    ...
    (
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} python train.py \
            --dataset_path "${DATA_ROOT}/3dovs/${casename}" \
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} bash "${REPO_ROOT}/eval/eval_3dovs.sh" "${casename}" \
